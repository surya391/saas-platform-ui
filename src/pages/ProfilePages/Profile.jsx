...
const Profile = () => {
  ...
  const limit = profile?.usage?.no_of_contacts?.limit ?? 0;
  const used = profile?.usage?.no_of_contacts?.used ?? 0;
          ...
          {profile ? (
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
              <div className="space-y-4 text-gray-700 text-lg">
                ...
                <p>
                  <span className="font-semibold">📈 Contact Limit:</span> {limit}
                </p>
                <p>
                  <span className="font-semibold">📊 Used Contacts:</span> {used}
                </p>
                <div className="mt-6">
